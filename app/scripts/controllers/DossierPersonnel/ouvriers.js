...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:OuvriersCtrl
 * @description
 * # OuvriersCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('OuvriersCtrl', function($scope, translatedwords,
    $compile,
    $uibModal,
    _url,
    DTOptionsBuilder,
    ...
    pc.data = {
      "modalTitle": {
        "create": "Ajouter un ouvrier",
        "update": "Mise a jour"
      },
      "niveau": "Ouvrier",
      "baseUrl": _url,
      "confirmeDeleteText": "Etes-vous sur de supprimer ce Ouvrier ?",
    ...
    pc.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        Ouviers.getOuviers(_url).then(function(result) {
