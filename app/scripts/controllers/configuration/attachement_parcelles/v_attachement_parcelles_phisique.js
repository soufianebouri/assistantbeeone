...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:ConfigurationAttachementParcellesVAttachementParcellesPhisiqueCtrl
 * @description
 * # ConfigurationAttachementParcellesVAttachementParcellesPhisiqueCtrl
  ...
  $scope.getSelectedIDs = async function(data) {
    ...
    vm.dtColumns = [
      DTColumnBuilder.newColumn(null)
        ...
        DTColumnBuilder.newColumn("Ref").withTitle("Réference Technique"),        
