...
angular.module('beeOneWebFrontApp')
  .controller('ConfigurationMainConfigurationCtrl', function($scope,toastr , $timeout, $q, mainAssist, auth, _url, $window, $state, $translatePartialLoader, $translate,onboarding, _version) {
    var vm = this;
