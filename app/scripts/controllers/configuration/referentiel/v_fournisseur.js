    ...
    $scope.validateData = async function() {
        ...
        vm.jsonData.forEach((item, index) => {
            ...
            if (item.FermeName ) {
              ...
              let newRef = vm.data_fournisseur.some(data_article => String(data_article.Ref).toUpperCase() === String(item.Ref).toUpperCase() );
            ...
            if (!item.Designation) {
              ...
              let newDesignation = vm.data_fournisseur.some(data_article => String(data_article.Designation).toUpperCase() === String(item.Designation).toUpperCase());
              if(newDesignation){
