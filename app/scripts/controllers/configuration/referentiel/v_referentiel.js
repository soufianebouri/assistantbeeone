  ...
  .controller('ConfigurationReferentielVReferentielCtrl', function (
    ...
    vm.gostep = function(index){
      if(index == 1){
        ...
        vm.stepUrl = "views/configuration/referentiel/v_profile_production.html";
      }else if(index == 7){
        ...
        vm.stepUrl = "views/configuration/referentiel/v_engrais.html";
      }else if(index == 12) {
        vm.stepUrl = "views/configuration/referentiel/v_pesticide.html";
      }else if(index == 13) {
        vm.stepUrl = "views/configuration/referentiel/v_depot.html";
      }else if(index == 14) {
        vm.stepUrl = "views/configuration/referentiel/v_operation.html";
      }else if(index == 15) {
        vm.stepUrl = "views/configuration/referentiel/v_prime.html";
      }else {
