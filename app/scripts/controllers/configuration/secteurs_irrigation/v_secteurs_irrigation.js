...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:ConfigurationSecteursIrrigationVSecteursIrrigationCtrl
 * @description
 * # ConfigurationSecteursIrrigationVSecteursIrrigationCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('ConfigurationSecteursIrrigationVSecteursIrrigationCtrl', function (
    $scope,
    $state,
    $timeout,
    _url,
    ...
    vm.currect_step = 3;
    vm.stepUrl = "views/configuration/secteurs_irrigation/v_sousparcelle.html";
    ...
    vm.gostep = function(index){
      if(index == 1){
        ...
        vm.stepUrl = "views/configuration/secteurs_irrigation/777.html";
      }
    }
