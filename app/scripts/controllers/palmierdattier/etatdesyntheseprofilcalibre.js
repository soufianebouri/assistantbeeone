...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:PalmierdattierEtatdesyntheseprofilcalibreCtrl
 * @description
 * # PalmierdattierEtatdesyntheseprofilcalibreCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('PalmierdattierEtatdesyntheseprofilcalibreCtrl', function($scope, $q, translatedwords, toastr, ProfilCalibre, analyseQualitative, $translatePartialLoader, $translate, $window, AgreageFruit, pourcentageOuverture, familleCible, $state, campagneagricole, domaine, parcellecultural, $cookies, savefilter) {
    NProgress.start();
    var pc = this;
    ...
    pc.loadSynthesisData = () => {
      $q.all([ProfilCalibre.getNbreFruitscontroleForSynthese(pc.obj), ProfilCalibre.getCalibreforSynthese(pc.obj), ProfilCalibre.getNbravecdiametreCalibreforSynthese(pc.obj)]).then(function(values) {
