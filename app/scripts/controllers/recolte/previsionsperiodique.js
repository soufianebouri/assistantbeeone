  ...
  .controller('PrevisionsperiodiqueCtrl', function($scope, $translatePartialLoader, $translate, $window, DTOptionsBuilder, DTColumnBuilder, $q, $compile, AgreageFruit, $state, $cookies, parcellecultural, campagneagricole,
    ...
    pc.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
      ...
      .withButtons([{
          ...
          className: 'pull-left' + (($cookies.getObject('globals').currentUser.isAdmin) ? '' : (((permission.a) ? '' : ' disabled'))),
    ...
    function DialogController($scope, $mdDialog) {
      ...
      $scope.saveData = function() {
        var rqtPart = "('" + moment().format('YYYY-MM-DD') + "','" + moment().format("HH:mm:ss") + "','" + $cookies.getObject('globals').currentUser.Nom + " " + $cookies.getObject('globals').currentUser.Prenom + "',";
