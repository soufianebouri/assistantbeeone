...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:RecoltePrevisiontodayCtrl
 * @description
 * # RecoltePrevisiontodayCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('RecoltePrevisiontodayCtrl', function($scope, $translatePartialLoader, $translate, $window, DTOptionsBuilder, DTColumnBuilder, $q, $compile, AgreageFruit, $state, $cookies, parcellecultural, campagneagricole,
    ...
    pc.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        PeriodeEstimation.getEstimationAujourdhui(pc.obj).then(function(result) {
