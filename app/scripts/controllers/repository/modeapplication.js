...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:RepositoryModeapplicationCtrl
 * @description
 * # RepositoryModeapplicationCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('RepositoryModeapplicationCtrl', function($scope,
    $compile,
    $uibModal,
    _url,
    DTOptionsBuilder,
    DTColumnBuilder,
    $q, translatedwords,
    ModeApplication, $translatePartialLoader, $translate, $window,
    $filter,
    DTDefaultOptions
  ) {
    ...
    pc.data = {
      "modalTitle": {
        "create": "Ajouter un mode d'application",
        "update": "Mise a jour"
      },
      "name": "Référence",
      "baseUrl": _url,
      "confirmeDeleteText": "Etes-vous sur de supprimer ce mode ?",
    ...
    pc.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        ModeApplication.getModeApplication(_url).then(function(result) {
    ...
    pc.dtColumns = [
      DTColumnBuilder.newColumn('Mode_Application').withTitle(translatedwords.getTranslatedWord($translate("Mode d'application"))),
    ...
    function edit(c) {
      ...
      pc.data.updateObj.Mode_Application = c.Mode_Application;
      pc.showModal('', "u");
    ...
    pc.showModal = function(size, req) {
      var template = './views/templates/modalmodeapplication.html';
      ...
      var modalInstance = $uibModal.open({
        ...
        controller: 'ModalModeApplicationCtrl',
        controllerAs: 'pc',
        size: size,
        resolve: {
          data: function() {
      ...
      modalInstance.result.then(function(res) {
        if (res == 'delete') {
          ModeApplication.deleteModeApplication(_url, {
            ID: pc.idToDelete
