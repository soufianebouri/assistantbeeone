...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:RepositoryNiveauconformiteCtrl
 * @description
 * # RepositoryNiveauconformiteCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('RepositoryNiveauconformiteCtrl', function($scope,
    $compile,
    $uibModal,
    _url,
    DTOptionsBuilder,
    DTColumnBuilder,
    $q, translatedwords,
    NiveauConformite, $translatePartialLoader, $translate, $window,
    $filter,
    DTDefaultOptions
  ) {
    ...
    pc.data = {
      "modalTitle": {
        "create": "Ajouter un niveau de conformité",
        "update": "Mise a jour"
      },
      "name": "Référence",
      "baseUrl": _url,
    ...
    pc.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        NiveauConformite.getNiveauConformite(_url).then(function(result) {
    ...
    pc.dtColumns = [
      DTColumnBuilder.newColumn('Niveau_Conformite').withTitle(translatedwords.getTranslatedWord($translate("Niveau conformité"))),
    ...
    function edit(c) {
      ...
      pc.data.updateObj.Niveau_Conformite = c.Niveau_Conformite;
      pc.showModal('', "u");
    ...
    pc.showModal = function(size, req) {
      var template = './views/templates/modalniveauconformite.html';
      ...
      var modalInstance = $uibModal.open({
        ...
        controller: 'ModalConformiteCtrl',
        controllerAs: 'pc',
        size: size,
        resolve: {
          data: function() {
      ...
      modalInstance.result.then(function(res) {
        if (res == 'delete') {
          NiveauConformite.deleteNiveauConformite(_url, {
            ID: pc.idToDelete
