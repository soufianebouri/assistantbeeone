...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:RepositoryProduitgeneraleCtrl
 * @description
 * # RepositoryProduitgeneraleCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('RepositoryProduitgeneraleCtrl', function($scope, $translatePartialLoader, translatedwords, $translate, $window,
    ...
    pc.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
      ...
      .withButtons([{
        ...
        },
        {
          ...
          titleAttr: translatedwords.getTranslatedWord($translate("Détails produit (Vue détaillée)"))
        },
        {
