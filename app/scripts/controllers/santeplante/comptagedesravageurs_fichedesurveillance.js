...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:SanteplanteComptagedesravageursFichedesurveillanceCtrl
 * @description
 * # SanteplanteComptagedesravageursFichedesurveillanceCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('SanteplanteComptagedesravageursFichedesurveillanceCtrl', function($scope, translatedwords, $window, DTOptionsBuilder, $translatePartialLoader, $translate, DTColumnBuilder, $q, $compile, $state, DTDefaultOptions, $cookies, comptagedesravageurs, parcellecultural, Cible, _url, savefilter) {
    ...
    pc.loadData = () => {
      $q.all([comptagedesravageurs.getDistinctedCible(pc.obj), comptagedesravageurs.getArbreParcelle(pc.obj), comptagedesravageurs.getNbrInsectes(pc.obj)]).then(function(values) {
    ...
    pc.printExcel = (e) => {
      $("#tableDataShow").table2excel({
        filename: "Fiche de surveillance.xls",
        preserveColors: true
      });
    };
