...
/**
 * @ngdoc function
 * @name beeOneWebFrontApp.controller:SynthesePlantationIntensitefleursCtrl
 * @description
 * # SynthesePlantationIntensitefleursCtrl
 * Controller of the beeOneWebFrontApp
 */
angular.module('beeOneWebFrontApp')
  .controller('SynthesePlantationIntensitefleursCtrl', function($scope, translatedwords, $q, $window, $translatePartialLoader, pourcentageOuverture, $translate, $state, campagneagricole, domaine, parcellecultural, IntensiteFleur, $cookies, savefilter) {
    NProgress.start();
    var pc = this;
    ...
    pc.loadSynthesisData = () => {
      $q.all([IntensiteFleur.getParcelWithArbre(pc.obj), IntensiteFleur.getParcelWithOrientation(pc.obj)]).then(function(values) {
