(function(f) {
  ...
  function l(a, b, d) {
    ...
    d && (d.attr && f(c).attr(d.attr), d.children &&
      ...
      if (f.isPlainObject(d)) v(d);
        ...
        if (n) {
          ...
          for (e = c.attributes.length - 1; 0 <= e; e--) {
            ...
            var q = c.attributes[e].nodeValue; - 1 !== g.indexOf(":") && (h.push({
              name: g,
              value: q
            }), c.removeAttribute(g))
          }
          e = 0;
          for (g = h.length; e < g; e++) q = d.createAttribute(h[e].name.replace(":", "_dt_b_namespace_token_")), q.value = h[e].value, c.setAttributeNode(q)
        }
  ...
  h.Client.prototype = {
    ...
    destroy: function() {
      var a = this;
      this.domElement && this.div && (f(this.div).remove(), this.div = this.domElement = null, f.each(h.clients, function(b, d) {
    ...
    receiveEvent: function(a, b) {
      ...
      if (this.handlers[a])
        for (var c =
          ...
          if ("function" == typeof g) g(this, b);
          else if ("object" == typeof g && 2 == g.length) g[0][g[1]](this, b);
          else if ("string" == typeof g) j[g](this, b)
        }
    }
  };
  h.hasFlash = function() {
  ...
  var x = function(a,
    ...
    r = function(a, b) {
      ...
      "function" === typeof d && (d = d()); - 1 !== d.indexOf("*") && (d = f.trim(d.replace("*", f("title").text())));
    ...
    y = function(a, b) {
      for (var d = b.newline ? b.newline : navigator.userAgent.match(/Windows/) ? "\r\n" : "\n", c = a.buttons.exportData(b.exportOptions), e = b.fieldBoundary, g = b.fieldSeparator, f = RegExp(e, "g"), h = b.escapeChar !== o ? b.escapeChar : "\\", j = function(a) {
          for (var b = "", c = 0, d = a.length; c < d; c++) 0 < c && (b += g), b += e ? e + ("" + a[c]).replace(f, h + e) + e : a[c];
          return b
        }, k = b.header ? j(c.header) + d : "", m = b.footer && c.footer ? d + j(c.footer) : "", l = [], u = 0, B = c.body.length; u < B; u++) l.push(j(c.body[u]));
      return {
        str: k + l.join(d) + m,
        rows: l.length
      }
  ...
  i.ext.buttons.copyFlash = f.extend({}, t, {
    ...
    action: function(a, b, d, c) {
      c._fromFlash && (a = c._flash, d = y(b, c), c = c.customize ? c.customize(d.str, c) : d.str, a.setAction("copy"), s(a, c), b.buttons.info(b.i18n("buttons.copyTitle",
  ...
  i.ext.buttons.excelFlash = f.extend({}, t, {
    ...
    action: function(a, b, d, c) {
      var a = c._flash,
        e = 0,
        g = f.parseXML(p["xl/worksheets/sheet1.xml"]),
        h = g.getElementsByTagName("sheetData")[0],
        d = {
          _rels: {
        ...
        j, k, i = function(a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            for (var d = b, i = ""; 0 <= d;) i = String.fromCharCode(d % 26 + 65) + i, d = Math.floor(d / 26) - 1;
            d = i + "" + j;
            ...
            }) : (i = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, ""), d = l(g, "c", {
              attr: {
                t: "inlineStr",
                r: d
              },
      ...
      c.header && (i(b.header, e), f("row c", g).attr("s", "2"));
      for (var m = 0, n = b.body.length; m < n; m++) i(b.body[m], e);
      c.footer && b.footer && (i(b.footer, e), f("row:last c", g).attr("s", "2"));
      i = l(g, "cols");
      f("worksheet", g).prepend(i);
      m = 0;
      for (n = b.header.length; m < n; m++) i.appendChild(l(g, "col", {
        attr: {
          min: m + 1,
          max: m + 1,
          width: z(b, m),
