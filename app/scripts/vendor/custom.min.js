function init_sidebar() {
  ...
  $SIDEBAR_MENU.find('.child_menu').on('mouseleave', function(ev) {
    var $li = $(this).parent();
    if ($li.is('.active')) {

      $BODY.hasClass("nav-md") ? '' : $li.removeClass('active active-sm');
  ...
  $SIDEBAR_MENU.find('a').on('click', function(ev) {
    ...
    if ($li.parent().is('.child_menu') && $("body").hasClass("nav-sm") && $li.find('ul').length == 0) {
      $SIDEBAR_MENU.find('.child_menu').removeAttr("style");
      $SIDEBAR_MENU.find('.child_menu').addClass('unshowed');
    }
...
function init_daterangepicker(from, to) {
  if (from == null) {
    from = to = moment();
  }
  ...
  if ("undefined" != typeof $.fn.daterangepicker) {
    ...
    var a = function(a, b, c) {
        if (a.format("DD/MM/YYYY") == b.format("DD/MM/YYYY")) {
          $("#reportrange span").html(a.format("DD/MM/YYYY"))
          $("#reportrange input").val(a.format("YYYYMMDD"))
          $("#reportrange input").trigger("change");
        } else {
          $("#reportrange span").html(a.format("DD/MM/YYYY") + " - " + b.format("DD/MM/YYYY"))
          $("#reportrange input").val(a.format("YYYYMMDD") + " - " + b.format("YYYYMMDD"))
          $("#reportrange input").trigger("change");
        }
      ...
      b = {
        ...
        ranges: {
          ...
          "Période en cours": [moment(from), moment(to)]
        },
        opens: "left",
    ...
    $("#reportrange span").html(moment().format("DD/MM/YYYY")), $("#reportrange").daterangepicker(b, a), $("#reportrange").on("show.daterangepicker", function() {
...
function init_daterangepicker_right() {
  if ("undefined" != typeof $.fn.daterangepicker) {
      ...
      b = {
        ...
        ranges: {
          ...
          /*'Hier': [moment().subtract(1, "days"), moment().subtract(1, "days")],
            ...
            "Ce mois-ci": [moment().startOf("month"), moment().endOf("month")],
            "Ce mois-ci": [moment().startOf("month"), moment().endOf("month")],*/
          "Période en cours": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")]
        },
        opens: "right",
        buttonClasses: ["btn btn-default"],
        applyClass: "btn-small btn-primary",
    ...
    $("#reportrange_right span").html(moment().format("DD/MM/YYYY")), $("#reportrange_right").daterangepicker(b, a), $("#reportrange_right").on("show.daterangepicker", function() {
      //console.log("show event fired")
...
function daterange_tb_technique(from, to) {
  ...
  if ("undefined" != typeof $.fn.daterangepicker) {
    var a = function(a, b, c) {
        /*if (a.format("DD/MM/YYYY") == b.format("DD/MM/YYYY")) {
          $("#reportrange_tb_technique span").html(a.format("DD/MM/YYYY"))
          $("#reportrange_tb_technique input").val(a.format("YYYYMMDD"))
      ...
      b = {
        ...
        ranges: {
          /*'Aujourd\'hui': [moment(), moment()],*/
          'Semaine': [moment().subtract(6, "days"), moment()],
          '15 jours': [moment().subtract(14, "days"), moment()],
          "1 mois": [moment().startOf("month"), moment().endOf("month")],
          "Trimestre": [moment().subtract(2, 'month').startOf("month"), moment().endOf("month")],
          "Annuel": [moment()]
        },
        opens: "left",
        buttonClasses: ["btn btn-default"],
...
$.fn.popover.Constructor.prototype.leave = function(a) {
  ...
  init_sparklines(), init_flot_chart(), init_sidebar(), init_wysiwyg(), init_InputMask(), init_JQVmap(), init_cropper(), init_knob(), init_IonRangeSlider(), init_ColorPicker(), init_TagsInput(), init_parsley(), init_daterangepicker(null, null), init_daterangepicker_right(), init_daterangepicker_single_call(), init_daterangepicker_reservation(), init_SmartWizard(), init_EasyPieChart(), init_charts(), init_echarts(), init_morris_charts(), init_skycons(), init_select2(), init_validator(), init_DataTables(), init_chart_doughnut(), init_gauge(), init_PNotify(), init_starrr(), init_calendar(), init_compose(), init_CustomNotification(), init_autosize(), init_autocomplete(), closeMenu(), daterange_tb_technique(null, null)
});