...
(() => {
  var e = {
      763: (e, t, r) => {
        ...
        var n = r(537),
          ...
          i = r(645),
          a = r.n(i)()(o());
        a.push([e.id, "body #magicMouseCursor{position:fixed;width:35px;height:35px;border:1px solid #5d8a36;border-radius:50%;z-index:9999;left:0;top:0;transition:transform .07s,width .3s,height .3s;pointer-events:none}body #magicMouseCursor.cursor-square{border-radius:0}body #magicPointer{height:5px;width:5px;top:0;left:0;position:fixed;background:#5d8a36;border-radius:50%;pointer-events:none;transition:background .2s,width .2s,height .2s,box-shadow .2s}body #magicPointer.pointer-blur{height:50px;width:50px;background:none;border:1px solid #5d8a36;box-shadow:0px 0px 15px -5px #5d8a36}body #magicPointer.pointer-overlay{height:50px;width:50px;mix-blend-mode:difference;box-shadow:0px 0px 15px -5px #5d8a36}body #magicPointer.is-hover{background:red}body .magic-hover{transition:all .2s}body .magic-hover:hover{cursor:none}", "", {
          version: 3,
          ...
          sourcesContent: ["body #magicMouseCursor{position:fixed;width:35px;height:35px;border:1px solid #5d8a36;border-radius:50%;z-index:9999;left:0;top:0;transition:transform .07s,width .3s,height .3s;pointer-events:none}body #magicMouseCursor.cursor-square{border-radius:0}body #magicPointer{height:5px;width:5px;top:0;left:0;position:fixed;background:#5d8a36;border-radius:50%;pointer-events:none;transition:background .2s,width .2s,height .2s,box-shadow .2s}body #magicPointer.pointer-blur{height:50px;width:50px;background:none;border:1px solid #5d8a36;box-shadow:0px 0px 15px -5px #5d8a36}body #magicPointer.pointer-overlay{height:50px;width:50px;mix-blend-mode:difference;box-shadow:0px 0px 15px -5px #5d8a36}body #magicPointer.is-hover{background:red}body .magic-hover{transition:all .2s}body .magic-hover:hover{cursor:none}"],
          sourceRoot: ""
        }]);
        const s = a
      },
        ...
        e.exports = function(e) {
          ...
          return t.toString = function() {
            ...
            for (var c = 0; c < e.length; c++) {
              var f = [].concat(e[c]);
              n && a[f[0]] || (void 0 !== i && (void 0 === f[5] || (f[1] = "@layer".concat(f[5].length > 0 ? " ".concat(f[5]) : "", " {").concat(f[1], "}")), f[5] = i), r && (f[2] ? (f[1] = "@media ".concat(f[2], " {").concat(f[1], "}"), f[2] = r) : f[2] = r), o && (f[4] ? (f[1] = "@supports (".concat(f[4], ") {").concat(f[1], "}"), f[4] = o) : f[4] = "".concat(o)), t.push(f))
            }
          }, t
        }
      },
      ...
      942: () => {
        ! function(e, t, r) {
          ...
          var f = u._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
          u._prefixes = f;
          var l = t.documentElement,
            d = "svg" === l.nodeName.toLowerCase(),
            p = u.testStyles = function(e, r, n, a) {
              var s, u, c, f, d = "modernizr",
                p = o("div"),
                h = i();
              if (parseInt(n, 10))
                for (; n--;)(c = o("div")).id = a ? a[n] : d + (n + 1), p.appendChild(c);
              return (s = o("style")).type = "text/css", s.id = "s" + d, (h.fake ? h : p).appendChild(s), h.appendChild(p), s.styleSheet ? s.styleSheet.cssText = e : s.appendChild(t.createTextNode(e)), p.id = d, h.fake && (h.style.background = "", h.style.overflow = "hidden", f = l.style.overflow, l.style.overflow = "hidden", l.appendChild(h)), u = r(p, e), h.fake ? (h.parentNode.removeChild(h), l.style.overflow = f, l.offsetHeight) : p.parentNode.removeChild(p), !!u
            };
            ...
            function() {
              ...
              for (var f in s)
                if (s.hasOwnProperty(f)) {
                  if (e = [], (t = s[f]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))
                    for (r = 0; r < t.options.aliases.length; r++) e.push(t.options.aliases[r].toLowerCase());
                  for (o = n(t.fn, "function") ? t.fn() : t.fn, i = 0; i < e.length; i++) 1 === (u = e[i].split(".")).length ? c[u[0]] = o : (!c[u[0]] || c[u[0]] instanceof Boolean || (c[u[0]] = new Boolean(c[u[0]])), c[u[0]][u[1]] = o), a.push((o ? "" : "no-") + u.join("-"))
                }
            }(),
            function(e) {
              var t = l.className,
              ...
              c._config.enableClasses && (t += " " + r + e.join(" " + r), d ? l.className.baseVal = t : l.className = t)
  ...
  (() => {
      ...
      return function t(r, n) {
        switch (arguments.length) {
          case 0:
            return t;
          case 1:
            return m(r) ? t : v((function(t) {
              return e(r, t)
            }));
          default:
            return m(r) && m(n) ? t : m(r) ? v((function(t) {
              return e(t, n)
            })) : m(n) ? v((function(t) {
              return e(r, t)
            })) : e(r, n)
    ...
    y.styleTagTransform = p(), y.setAttributes = c(), y.insert = s().bind(null, "head"), y.domAPI = i(), y.insertStyleElement = l(), t()(h.Z, y), h.Z && h.Z.locals && h.Z.locals;
    const g = Array.isArray || function(e) {
      ...
      return function() {
        ...
        if (!g(n)) {
          for (var o = 0; o < e.length;) {
            if ("function" == typeof n[e[o]]) return n[e[o]].apply(n, Array.prototype.slice.call(arguments, 0, -1));
            o += 1
          }
          if (b(n)) {
    ...
    const S = v((function(e) {
      return !!g(e) || !!e && "object" == typeof e && !O(e) && (0 === e.length || e.length > 0 && e.hasOwnProperty(0) && e.hasOwnProperty(e.length - 1))
    }));
    var j = function() {
      function e(e) {
        this.f = e
    ...
    var P = function() {
      ...
      return e.prototype["@@transducer/init"] = x, e.prototype["@@transducer/result"] = w, e.prototype["@@transducer/step"] = function(e, t) {
    ...
    function T(e, t, r) {
      return function() {
        for (var n = [], o = 0, i = e, a = 0; a < t.length || o < arguments.length;) {
          var s;
          a < t.length && (!m(t[a]) || o >= arguments.length) ? s = t[a] : (s = arguments[o], o += 1), n[a] = s, m(s) || (i -= 1), a += 1
        }
    ...
    const F = "function" != typeof Object.keys || R ? v((function(e) {
        if (Object(e) !== e) return [];
        var t, r, n = [],
          o = R && _(e);
        for (t in e) !N(t, e) || o && "length" === t || (n[n.length] = t);
        if (W)
          for (r = z.length - 1; r >= 0;) N(t = z[r], e) && !D(n, t) && (n[n.length] = t), r -= 1;
        return n
      })) : v((function(e) {
        return Object(e) !== e ? [] : Object.keys(e)
      })),
      H = A(C(["fantasy-land/map", "map"], L, (function(e, t) {
        switch (Object.prototype.toString.call(t)) {
          ...
          case "[object Object]":
            return function(e, t, r) {
              ...
              if ("function" == typeof r["fantasy-land/reduce"]) return E(e, t, r, "fantasy-land/reduce");
          ...
          default:
            return function(e, t) {
              for (var r = 0, n = t.length, o = Array(n); r < n;) o[r] = e(t[r]), r += 1;
              return o
            }(e, t)
        }
      }))),
      ...
      return function t(r, n, o) {
        switch (arguments.length) {
          case 0:
            return t;
          case 1:
            return m(r) ? t : A((function(t, n) {
              return e(r, t, n)
            }));
          case 2:
            return m(r) && m(n) ? t : m(r) ? A((function(t, r) {
              return e(t, n, r)
            })) : m(n) ? A((function(t, n) {
              return e(r, t, n)
            })) : v((function(t) {
          ...
          default:
            return m(r) && m(n) && m(o) ? t : m(r) && m(n) ? A((function(t, r) {
              return e(t, r, o)
            })) : m(r) && m(o) ? A((function(t, r) {
              return e(t, n, r)
            })) : m(n) && m(o) ? A((function(t, n) {
              return e(r, t, n)
            })) : m(r) ? v((function(t) {
              return e(t, n, o)
            })) : m(n) ? v((function(t) {
    ...
    function te(e, t, r, n) {
      ...
      switch (a) {
        case "Map":
          return e.size === t.size && ee(e.entries(), t.entries(), r.concat([e]), n.concat([t]));
        case "Set":
          return e.size === t.size && ee(e.values(), t.values(), r.concat([e]), n.concat([t]));
        case "Arguments":
        case "Array":
        case "Object":
        case "Boolean":
    ...
    var ne = function() {
      ...
      return e.prototype["@@transducer/init"] = x, e.prototype["@@transducer/result"] = function(e) {
    ...
    const oe = A(C(["find"], A((function(e, t) {
      return new ne(e, t)
    })), (function(e, t) {
    ...
    class se {
      ...
      constructor(e) {
        ...
        for (let t in e) this.isValid(t, e[t]) && (this.defaultOptions[t] = e[t]);
      ...
      isValid(e, t) {
        if (!X("name", ae).includes(e)) return console.error(`${e} is not a valid option`), !1;
    ...
    const ue = e => {
      if (console.log(e), e = new se(e), !Modernizr.touchevents) {
        ...
        document.addEventListener("mousemove", (function(e) {
          l = e.clientX, d = e.clientY, setTimeout((() => {
          ...
          e.addEventListener("mouseenter", (e => {
            r.style.opacity = 0, o.style.opacity = 0, document.body.style.cursor = "auto"
          })), e.addEventListener("mouseleave", (e => {
            r.style.opacity = 1, o.style.opacity = 1, document.body.style.cursor = "none"
          }))
        }));
        var h = () => {
          r && (r.style.transform = "matrix(1, 0, 0, 1, " + c + ", " + f + ")", r.style.width = i + "px", r.style.height = a + "px"), o && (o.style.transform = "matrix(1, 0, 0, 1, " + l + ", " + d + ") translate3d(-50%, -50%, 0)"), requestAnimationFrame(h)
        };
        ...
        const y = e => {
            if (p = !0, r) {
              ...
              e.classList.contains("magic-hover__square") ? (r.classList.add("cursor-square"), c = t.left, f = t.top, i = t.width, a = t.height) : (c = t.left, f = t.top, i = t.width, a = t.height)
            }
            o && o.classList.add("is-hover")
          },
          m = () => {
            p = !1, r && (i = s, a = u, r.style.transition = "transform 0.07s, width 0.3s, height 0.3s, border-radius 0.2s", r.classList.remove("cursor-square"), r.classList.remove("is-hover")), o && o.classList.remove("is-hover")
          },
          v = (e, t) => {
            o && o.classList.add(t)
          },
